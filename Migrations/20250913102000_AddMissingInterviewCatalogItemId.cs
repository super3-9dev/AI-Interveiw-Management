...
{
    /// <inheritdoc />
    public partial class AddMissingInterviewCatalogItemId : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // Add the missing InterviewCatalogItemId column to InterviewSessions
